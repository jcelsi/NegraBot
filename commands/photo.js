...
const db = require('../data/negra.json');

/*
const db = {
	"urls":[
		"https://i.imgur.com/vsen6Tf.png",
		"https://i.imgur.com/NOn11cE.png",
		"https://i.imgur.com/Em1aeos.png",
		"https://i.imgur.com/FQWuM4M.png",
		"https://i.imgur.com/J8ZZfdI.png",
		"https://i.imgur.com/WnfuXFT.png",
		"https://i.imgur.com/FXK1J7D.png",
		"https://i.imgur.com/2x0sOpc.png",
		"https://i.imgur.com/YJNtTGR.png"
	],
	"quotes":[
		"2024",
...
module.exports = {
	...
	async execute(interaction) {
		const url = db.urls[Math.floor(Math.random() * db.urls.length)];
		const quote = db.quotes[Math.floor(Math.random() * db.quotes.length)];
		const exampleEmbed = new EmbedBuilder()
			.setColor(0x0099FF)
			.addFields(
				{ name: 'Negra says', value: quote },
			)
			.setImage(url);
